...
#define COM_MOBMAP_15A 0x0100
#define COM_MOBMAP_15B 0x0200
#define COM_MOBMAP_15C 0x0300
#define COM_MOBMAP_16A 0x0400
...
public:
	...
	static LRESULT PR_HARAIPANEL_PROC(HWND, UINT, WPARAM, LPARAM);
